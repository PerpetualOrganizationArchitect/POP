...
contract PoaManagerSatellite is Ownable2Step, IMessageRecipient {
    /*──────────── Constants ───────────*/
    ...
    /*──────────── Constructor ─────────*/
    constructor(address _poaManager, address _mailbox, uint32 _hubDomain, address _hubAddress) Ownable(msg.sender) {
