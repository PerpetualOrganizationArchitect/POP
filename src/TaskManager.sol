...
contract TaskManager is Initializable, ContextUpgradeable {
    ...
    event TaskUpdated(uint256 indexed id, uint256 payout, address bountyToken, uint256 bountyPayout, bytes title, bytes32 metadataHash);
    ...
    function createAndAssignTask(
        ...
        return _createAndAssignTask(payout, title, metadataHash, pid, assignee, requiresApplication, bountyToken, bountyPayout);
    }
