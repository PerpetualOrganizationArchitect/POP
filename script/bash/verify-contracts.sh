...
#
# Usage:
#   ./script/bash/verify-contracts.sh                    # Verify all on both chains
#   ./script/bash/verify-contracts.sh --chain arbitrum    # Arbitrum only
#   ./script/bash/verify-contracts.sh --chain gnosis      # Gnosis only
#   ./script/bash/verify-contracts.sh --dry-run           # Print commands without running
#############################################################################
