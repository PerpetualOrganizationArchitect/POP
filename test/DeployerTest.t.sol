...
contract DeployerTest is Test {
    ...
    function testFullOrgDeployWithAutoUpgrade() public {
        ...
        uint256 proposalsCount = votingContract.getProposalsCount();
    ...
    function testRegistryOperations() public {
        ...
        string memory latestVersion = implementationRegistry.getVersionAtIndex("DirectDemocracyVoting", implementationRegistry.getVersionCount("DirectDemocracyVoting") - 1);
