...
contract MockToken is IERC20 {
    ...
    contract PVotingTest is Test {
        ...
        function testSetCreatorHatAllowed() public {
            ...
            vm.prank(address(exec));
            pv.setConfig(
                ParticipationVoting.ConfigKey.HAT_ALLOWED,
                abi.encode(ParticipationVoting.HatType.CREATOR, newHatId, true)
            );
            ...
            pv.setConfig(
                ParticipationVoting.ConfigKey.HAT_ALLOWED,
                abi.encode(ParticipationVoting.HatType.CREATOR, newHatId, false)
            );
